...
namespace WinFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        private void monthCalendar1_DateChanged(object sender, DateRangeEventArgs e)
        {
            ...
            lbl_start_date.Text = monthCalendar1.SelectionStart.ToShortDateString();
        ...
        private void btn_load_Click(object sender, EventArgs e)
        {
            ...
            // lBox_students.ValueMember = "Name";
        }
        ...
        {
            var student = lBox_students.SelectedItem as Student;

            lbl_student.Text = $"{student?.Id} - {student?.Name}";
        }

        private void btn_student_Click(object sender, EventArgs e)
        {
            lBox_students.Items.Add(new Student("Nihat"));
        }
